...
class TestCrawlerFundsExplorer(unittest.TestCase):
    ...
    def test_eh_tipo_fii(self):
        ...
        assert eh_tipo_fii('SDIL15')
        assert eh_tipo_fii('SDIL16')
        assert eh_tipo_fii('SDIL17')
        assert eh_tipo_fii('SDIL18')
        assert eh_tipo_fii('SDIL19')
        assert eh_tipo_fii('SDIL20')
        assert eh_tipo_fii('SDIL21')
        assert eh_tipo_fii('SDIL22')
        assert eh_tipo_fii('SDIL23')
        assert eh_tipo_fii('SDIL24')
        assert eh_tipo_fii('SDIL25')
        assert eh_tipo_fii('SDIL26')
        assert eh_tipo_fii('SDIL27')
        assert eh_tipo_fii('SDIL28')
        assert eh_tipo_fii('SDIL29')
        assert eh_tipo_fii('SDIL30')
